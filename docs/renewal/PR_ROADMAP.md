...
| PR16 | 레거시 관측 로그 구조화 + 대시보드 플레이북 | 리뷰 |  | `chore/pr16-legacy-observability-dashboards` | https://github.com/wedosoft/agent-platform/pull/30 | `docs/renewal/LEGACY_OBSERVABILITY_PLAYBOOK.md` |
